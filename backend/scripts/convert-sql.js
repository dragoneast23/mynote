...
const sqlContent = fs.readFileSync('c:/Users/Administrator/Desktop/小程序/jxgjz美化/jxgjz美化/jxgjz/tools/note_2026-07-12_09-30-02_mysql_data.sql', 'utf-8');

let d1Sql = '';

d1Sql += '-- Import Users\n';
d1Sql += "INSERT OR REPLACE INTO users (id, username, password, openid, nickname, register_time, token, token_expire) VALUES\n";
d1Sql += "(1, NULL, NULL, 'oxKdt192HLNhOOKriSGAe32gqWwQ', '无情', '2025-10-09 08:29:49', NULL, NULL),\n";
d1Sql += "(2, '13582538844', '$2y$10$x9MlwrPe8VnD5daoCut87OuD43PmO7HwPRNw1CHJkFN2jXSTf7/ba', NULL, '13582538844', '2025-10-09 22:55:48', NULL, NULL);\n\n";

d1Sql += '-- Import Registers\n';
d1Sql += "INSERT OR IGNORE INTO registers (registercode) VALUES\n";
d1Sql += "('xTpixvgRlavw'),\n";
d1Sql += "('iHAZduBLTA'),\n";
d1Sql += "('7KikGh23jc'),\n";
d1Sql += "('cVprRLkZQYi'),\n";
...
d1Sql += '-- Import Admin\n';
d1Sql += "INSERT OR REPLACE INTO registers_admin (id, username, password_hash) VALUES\n";
d1Sql += "(1, 'along', '$2y$12$dr.NXlkorFuaQTRfS2eLZu8bfbgGBs5rwGJEGKJRUbaKTgSV3t6RC');\n\n";

d1Sql += '-- Import Notes from notes_1 (user_id=1)\n';
d1Sql += "INSERT INTO notes (user_id, title, content, create_time, update_time, word_count) VALUES\n";
d1Sql += "(1, '这是一个示例备忘录内容，您可以用此APP', '这是一个示例备忘录内容，您可以用此APP记录自己的日', '2025-10-13 17:21:30', '2026-04-17 10:29:59', 46),\n";
d1Sql += "(1, '这是我在云端更改的标题', '最新版本数据能不', '2025-10-13 21:16:29', '2026-07-03 15:14:26', 19),\n";
d1Sql += "(1, '19199496868546661819', '191994968685466618194664', '2025-10-13 21:32:48', '2025-10-13 21:32:48', 44),\n";
d1Sql += "(1, '64634578168361873679', '646345781683618736791316就是啊，是的啊', '2025-10-13 21:32:55', '2025-10-14 11:42:31', 51),\n";
d1Sql += "(1, '15973761546461664676', '1597376154646166467646', '2025-10-13 21:33:01', '2025-10-13 21:33:01', 42),\n";
d1Sql += "(1, ' 💾 💾 🔠 📀 💿 💽', ' 💾 🔠 📀 💿 💽比', '2025-10-21 22:57:23', '2025-10-22 11:07:12', 23),\n";
d1Sql += "(1, '咋打看着看着就', '咋打看着看着就', '2025-10-22 11:07:24', '2025-10-22 11:07:24', 14);\n\n";

d1Sql += '-- Import Notes from notes_2 (user_id=2)\n';
d1Sql += "INSERT INTO notes (user_id, title, content, create_time, update_time, word_count) VALUES\n";
...
fs.writeFileSync('scripts/migrate.sql', d1Sql);
console.log('SQL file generated: scripts/migrate.sql');
